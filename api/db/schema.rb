...
ActiveRecord::Schema.define(version: 20_210_528_204_810) do
  ...
  create_table 'test_questions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[question_type question_id], name: 'index_test_questions_on_question_type_and_question_id'
