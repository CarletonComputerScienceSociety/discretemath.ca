...
def test():
    ...
    assert test_output.test_output(main_0.call())
    assert test_output.test_output(main_1.call())
    assert test_output.test_output(main_2.call())
    assert test_output.test_output(main_3.call())
