"""Randomly generates the various types of "books_shelves_i" type problems"""
...
def generate_question():
    ...
    elif restriction == 2: # --> all bookshelves must be used, no empty bookshelves
    ...
    else: # restriction == 3: Identical Books Exists!
