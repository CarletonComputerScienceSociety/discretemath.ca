        ...
        function (require, module, exports) {
          ...
          Parser.prototype.parse = function () {
            ...
            while (true) {
              ...
              else throw new ParseError('Unexpected environment ' + envName);
          ...
          Parser.prototype._parseCond = Parser.prototype._parseCloseText =
            function () {
...
*/
          ...
          TextStyle.prototype.updateByCommand = function (cmd) {
            ...
            if (cmdStyles !== undefined) {
              for (var attr in cmdStyles) this._css[attr] = cmdStyles[attr];
              return;
            }
          ...
          TextStyle.prototype.toCSS = function () {
            ...
            if (this._fontSize !== this._outerFontSize) {
              cssStr +=
                'font-size:' + this._fontSize / this._outerFontSize + 'em;';
            }
            return cssStr;
          };
          ...
          TextEnvironment.prototype.renderToHTML = function () {
            ...
            while ((node = this._nodes.shift()) !== undefined) {
              ...
              switch (type) {
                ...
                default:
                  throw new ParseError(
                    'Unexpected ParseNode of type ' + node.type
                  );
              }
            }
          ...
          HTMLBuilder.prototype.beginDiv = function (
            className,
            style,
            extraStyle
          ) {
          ...
          HTMLBuilder.prototype.beginP = function (
            className,
            style,
            extraStyle
          ) {
          ...
          HTMLBuilder.prototype.beginSpan = function (
            className,
            style,
            extraStyle
          ) {
          ...
          HTMLBuilder.prototype.putHTML = HTMLBuilder.prototype.putSpan =
            function (html) {
              this._flushText();
...
*/
          HTMLBuilder.prototype._beginTag = function (
            tag,
            className,
            style,
            extraStyle
          ...
          function RendererOptions(options) {
            ...
            this.indentSize = options.indentSize
              ? this._parseEmVal(options.indentSize)
              : 1.2;
            this.commentDelimiter = options.commentDelimiter || ' // ';
            this.lineNumberPunc = options.lineNumberPunc || ':';
            this.lineNumber =
              options.lineNumber !== undefined ? options.lineNumber : false;
          ...
          Renderer.prototype._beginBlock = function () {
            ...
            var blockIndent =
              this._options.indentSize + extraIndentForFirstBlock;
            ...
            switch (node.type) {
              ...
              case 'loop':
                ...
                if (!this._options.noEnd) {
                  ...
                  this._newLine();
                  var endLoopName =
                    loopType === 'while' ? 'end while' : 'end for';
