...
class StringAllPositionsAreEqual extends Factory {
  ...
  generateOptionOne(setASize, even_or_odd) {
    let incorrectAnswerOne = this.generateCorrectAnswer(setASize, even_or_odd) / 4;
    return {
  ...
  generateOptionTwo(setASize, even_or_odd) {
    let incorrectAnswerTwo = this.generateCorrectAnswer(setASize, even_or_odd) / 2;
    return {
  ...
  generateOptionFour(setASize, even_or_odd) {
    let incorrectAnswerThree = this.generateCorrectAnswer(setASize, even_or_odd) * 2;
    return {
